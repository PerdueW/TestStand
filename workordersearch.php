...
<title>Individual Workorder/Order Search</title>
...
<body onload="focus()">
    <center><h1>Individual Workorder/Order Search</h1></center>    
    <nav id="nav01"></nav>
    <div id="main">            
        <form name="thmquery" id="query" action="connection.php?thmdbQuery" method="post">                                  
            <label for="msmac">MAC:</label>
            <input type="text" size="22" name="msmac" id="msmac" value="" maxlength="17" placeholder="MAC XX:XX:XX:XX:XX:XX"></input>
            &nbsp;&nbsp;&nbsp;&nbsp;  
