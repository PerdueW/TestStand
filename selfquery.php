...
<title> TestStand Self Query </title>
...
<body onload="focus()">
    <center><h1> TestStand Self Query </h1></center>    
    <nav id="nav01"></nav>
    <div id="main">            
        <form name="thmquery" id="query" action="connection.php?thmdbQuery" method="post">                                  
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;  
            <input type="button" value="submit" onclick="columnrsquery()" />
		    <label class="queryrunninglabel" id="queryrunninglabel"><br /> Query running...... <br /></label>
		    <br /> 
            <div name="columnresults" id="columnresults">  
                <table id="columnresultstable">                    
                </table>
            </div> 
            <br />
