...
<body>
    ...
    <div id="main">            
            ...
            <?php
				...
				$smodel1 = str_replace(' ', '', $smodel1);
				$testsuite = trim($testsuite);
				$testsuite = str_replace(' ', '_', $testsuite);
                $query = "show columns FROM m".$smodel1."__".$testsuite." where FIELD like '".$testnamex."%' and FIELD not like '%__status'";
			    ...
			    {		
					...
					{  							                  
						...
						{	                       
						    ...
						    $qStr1 = "select ".$newcolumns." from m".$smodel1."__".$testsuite." where mac='".$mac."' and testdatetime='".$testdatetime."'"; 
